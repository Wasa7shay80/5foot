...
async def start_command(client: Client, message: Message):
    ...
    if len(text)>7:
        ...
        for msg in messages:
            ...
            try:
                if msg and (msg.text or msg.photo or msg.document or msg.video or msg.audio or msg.sticker or msg.voice or msg.animation or msg.video_note or msg.contact or msg.location or>
                ...
                pass
        await message.reply_text(f"<b>support and share</b>")
        return
    else:
